...
// Fri Mar 24 23:03:27 2017 by ROOT version 6.02/05
...
#ifndef smearerAppliedToZ_h
#define smearerAppliedToZ_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   smearerAppliedToZ(TTree *tree=0);
   virtual ~smearerAppliedToZ();
...
#ifdef smearerAppliedToZ_cxx
smearerAppliedToZ::smearerAppliedToZ(TTree *tree) : fChain(0) 
{
...
smearerAppliedToZ::~smearerAppliedToZ()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t smearerAppliedToZ::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t smearerAppliedToZ::LoadTree(Long64_t entry)
{
...
void smearerAppliedToZ::Init(TTree *tree)
{
...
Bool_t smearerAppliedToZ::Notify()
{
...
void smearerAppliedToZ::Show(Long64_t entry)
{
...
Int_t smearerAppliedToZ::Cut(Long64_t entry)
{
...
#endif // #ifdef smearerAppliedToZ_cxx
