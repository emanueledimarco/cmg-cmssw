...
// Thu Apr 13 11:12:32 2017 by ROOT version 6.02/05
// from TTree treeProducerWMassEle/treeProducerWMassEle
// found on file: /cmsrm/pc29_2/emanuele/TREES_1LEP_53X_V1/DYJetsM50/treeProducerWMassEle/treeProducerWMassEle_tree.root
//////////////////////////////////////////////////////////

#ifndef eleFastSmearerValidDataMc_h
#define eleFastSmearerValidDataMc_h
...
class eleFastSmearerValidDataMc {
public :
   ...
   Int_t           nLepOther;
   Float_t         LepOther_pt[70];   //[nLepOther]
   Float_t         LepOther_eta[70];   //[nLepOther]
   Float_t         LepOther_phi[70];   //[nLepOther]
   Float_t         LepOther_mass[70];   //[nLepOther]
   Int_t           LepOther_pdgId[70];   //[nLepOther]
   Int_t           LepOther_charge[70];   //[nLepOther]
   Float_t         LepOther_dxy[70];   //[nLepOther]
   Float_t         LepOther_dz[70];   //[nLepOther]
   Float_t         LepOther_edxy[70];   //[nLepOther]
   Float_t         LepOther_edz[70];   //[nLepOther]
   Float_t         LepOther_ip3d[70];   //[nLepOther]
   Float_t         LepOther_sip3d[70];   //[nLepOther]
   Int_t           LepOther_tightId[70];   //[nLepOther]
   Int_t           LepOther_convVeto[70];   //[nLepOther]
   Int_t           LepOther_lostHits[70];   //[nLepOther]
   Int_t           LepOther_looseIdSusy[70];   //[nLepOther]
   Float_t         LepOther_relIso03[70];   //[nLepOther]
   Float_t         LepOther_relIso04[70];   //[nLepOther]
   Float_t         LepOther_chargedHadRelIso03[70];   //[nLepOther]
   Float_t         LepOther_chargedHadRelIso04[70];   //[nLepOther]
   Int_t           LepOther_convVetoFull[70];   //[nLepOther]
   Int_t           LepOther_eleCutId[70];   //[nLepOther]
   Int_t           LepOther_eleMVAId[70];   //[nLepOther]
   Int_t           LepOther_tightCharge[70];   //[nLepOther]
   Float_t         LepOther_mvaId[70];   //[nLepOther]
   Float_t         LepOther_mvaIdTrig[70];   //[nLepOther]
   Float_t         LepOther_nStations[70];   //[nLepOther]
   Float_t         LepOther_trkKink[70];   //[nLepOther]
   Float_t         LepOther_caloCompatibility[70];   //[nLepOther]
   Float_t         LepOther_globalTrackChi2[70];   //[nLepOther]
   Int_t           LepOther_trackerLayers[70];   //[nLepOther]
   Int_t           LepOther_pixelLayers[70];   //[nLepOther]
   Float_t         LepOther_mvaTTH[70];   //[nLepOther]
   Float_t         LepOther_jetPtRatio[70];   //[nLepOther]
   Float_t         LepOther_jetBTagCSV[70];   //[nLepOther]
   Float_t         LepOther_jetDR[70];   //[nLepOther]
   Int_t           LepOther_mcMatchId[70];   //[nLepOther]
   Int_t           LepOther_mcMatchAny[70];   //[nLepOther]
   Int_t           LepOther_mcMatchAny2[70];   //[nLepOther]
   Int_t           LepOther_mcMatchTau[70];   //[nLepOther]
   Int_t           LepOther_softMuID[70];   //[nLepOther]
   Float_t         LepOther_trgMatch[70];   //[nLepOther]
   Float_t         LepOther_scEta[70];   //[nLepOther]
   Float_t         LepOther_r9[70];   //[nLepOther]
   Float_t         LepOther_classification[70];   //[nLepOther]
   Float_t         LepOther_detaIn[70];   //[nLepOther]
   Float_t         LepOther_dphiIn[70];   //[nLepOther]
   Float_t         LepOther_sigmaIetaIeta[70];   //[nLepOther]
   Float_t         LepOther_sigmaIphiIphi[70];   //[nLepOther]
   Float_t         LepOther_hcalOverEcal[70];   //[nLepOther]
   Float_t         LepOther_correctedEcalEnergyError[70];   //[nLepOther]
   Float_t         LepOther_regressionEnergyError[70];   //[nLepOther]
   Float_t         LepOther_ecalEnergy[70];   //[nLepOther]
   Float_t         LepOther_superCluster_rawEnergy[70];   //[nLepOther]
   Float_t         LepOther_superCluster_preshowerEnergy[70];   //[nLepOther]
   Float_t         LepOther_superCluster_energy[70];   //[nLepOther]
   Float_t         LepOther_eSuperClusterOverP[70];   //[nLepOther]
   Int_t           nLepGood;
   Float_t         LepGood_pt[70];   //[nLepGood]
   Float_t         LepGood_eta[70];   //[nLepGood]
   Float_t         LepGood_phi[70];   //[nLepGood]
   Float_t         LepGood_mass[70];   //[nLepGood]
   Int_t           LepGood_pdgId[70];   //[nLepGood]
   Int_t           LepGood_charge[70];   //[nLepGood]
   Float_t         LepGood_dxy[70];   //[nLepGood]
   Float_t         LepGood_dz[70];   //[nLepGood]
   Float_t         LepGood_edxy[70];   //[nLepGood]
   Float_t         LepGood_edz[70];   //[nLepGood]
   Float_t         LepGood_ip3d[70];   //[nLepGood]
   Float_t         LepGood_sip3d[70];   //[nLepGood]
   Int_t           LepGood_tightId[70];   //[nLepGood]
   Int_t           LepGood_convVeto[70];   //[nLepGood]
   Int_t           LepGood_lostHits[70];   //[nLepGood]
   Int_t           LepGood_looseIdSusy[70];   //[nLepGood]
   Float_t         LepGood_relIso03[70];   //[nLepGood]
   Float_t         LepGood_relIso04[70];   //[nLepGood]
   Float_t         LepGood_chargedHadRelIso03[70];   //[nLepGood]
   Float_t         LepGood_chargedHadRelIso04[70];   //[nLepGood]
   Int_t           LepGood_convVetoFull[70];   //[nLepGood]
   Int_t           LepGood_eleCutId[70];   //[nLepGood]
   Int_t           LepGood_eleMVAId[70];   //[nLepGood]
   Int_t           LepGood_tightCharge[70];   //[nLepGood]
   Float_t         LepGood_mvaId[70];   //[nLepGood]
   Float_t         LepGood_mvaIdTrig[70];   //[nLepGood]
   Float_t         LepGood_nStations[70];   //[nLepGood]
   Float_t         LepGood_trkKink[70];   //[nLepGood]
   Float_t         LepGood_caloCompatibility[70];   //[nLepGood]
   Float_t         LepGood_globalTrackChi2[70];   //[nLepGood]
   Int_t           LepGood_trackerLayers[70];   //[nLepGood]
   Int_t           LepGood_pixelLayers[70];   //[nLepGood]
   Float_t         LepGood_mvaTTH[70];   //[nLepGood]
   Float_t         LepGood_jetPtRatio[70];   //[nLepGood]
   Float_t         LepGood_jetBTagCSV[70];   //[nLepGood]
   Float_t         LepGood_jetDR[70];   //[nLepGood]
   Int_t           LepGood_mcMatchId[70];   //[nLepGood]
   Int_t           LepGood_mcMatchAny[70];   //[nLepGood]
   Int_t           LepGood_mcMatchAny2[70];   //[nLepGood]
   Int_t           LepGood_mcMatchTau[70];   //[nLepGood]
   Int_t           LepGood_softMuID[70];   //[nLepGood]
   Float_t         LepGood_trgMatch[70];   //[nLepGood]
   Float_t         LepGood_scEta[70];   //[nLepGood]
   Float_t         LepGood_r9[70];   //[nLepGood]
   Float_t         LepGood_classification[70];   //[nLepGood]
   Float_t         LepGood_detaIn[70];   //[nLepGood]
   Float_t         LepGood_dphiIn[70];   //[nLepGood]
   Float_t         LepGood_sigmaIetaIeta[70];   //[nLepGood]
   Float_t         LepGood_sigmaIphiIphi[70];   //[nLepGood]
   Float_t         LepGood_hcalOverEcal[70];   //[nLepGood]
   Float_t         LepGood_correctedEcalEnergyError[70];   //[nLepGood]
   Float_t         LepGood_regressionEnergyError[70];   //[nLepGood]
   Float_t         LepGood_ecalEnergy[70];   //[nLepGood]
   Float_t         LepGood_superCluster_rawEnergy[70];   //[nLepGood]
   Float_t         LepGood_superCluster_preshowerEnergy[70];   //[nLepGood]
   Float_t         LepGood_superCluster_energy[70];   //[nLepGood]
   Float_t         LepGood_eSuperClusterOverP[70];   //[nLepGood]
   Int_t           nJetFwd;
   Float_t         JetFwd_pt[20];   //[nJetFwd]
   Float_t         JetFwd_eta[20];   //[nJetFwd]
   Float_t         JetFwd_phi[20];   //[nJetFwd]
   Float_t         JetFwd_mass[20];   //[nJetFwd]
   Float_t         JetFwd_btagCSV[20];   //[nJetFwd]
   Float_t         JetFwd_rawPt[20];   //[nJetFwd]
   Float_t         JetFwd_mcPt[20];   //[nJetFwd]
   Int_t           JetFwd_mcFlavour[20];   //[nJetFwd]
   Float_t         JetFwd_quarkGluonID[20];   //[nJetFwd]
   Int_t           JetFwd_mcMatchId[20];   //[nJetFwd]
   Int_t           JetFwd_mcMatchFlav[20];   //[nJetFwd]
   Int_t           JetFwd_puId[20];   //[nJetFwd]
   Float_t         JetFwd_area[20];   //[nJetFwd]
   Int_t           JetFwd_id[20];   //[nJetFwd]
   Float_t         JetFwd_CHEF[20];   //[nJetFwd]
   Float_t         JetFwd_NHEF[20];   //[nJetFwd]
   Float_t         JetFwd_PHEF[20];   //[nJetFwd]
   Float_t         JetFwd_MUEF[20];   //[nJetFwd]
   Float_t         JetFwd_ELEF[20];   //[nJetFwd]
   Int_t           nJet;
   ...
   Float_t         Jet_quarkGluonID[30];   //[nJet]
   ...
   Float_t         Jet_CHEF[30];   //[nJet]
   Float_t         Jet_NHEF[30];   //[nJet]
   Float_t         Jet_PHEF[30];   //[nJet]
   Float_t         Jet_MUEF[30];   //[nJet]
   Float_t         Jet_ELEF[30];   //[nJet]
   Int_t           nGenLep;
   ...
   Float_t         GenLep_charge[5];   //[nGenLep]
   Int_t           GenLep_sourceId[5];   //[nGenLep]
   Int_t           nGenP6StatusThree;
   Float_t         GenP6StatusThree_pt[30];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_eta[30];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_phi[30];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_mass[30];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_pdgId[30];   //[nGenP6StatusThree]
   Float_t         GenP6StatusThree_charge[30];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_motherId[30];   //[nGenP6StatusThree]
   Int_t           GenP6StatusThree_grandmaId[30];   //[nGenP6StatusThree]
   ...
   eleFastSmearerValidDataMc(TTree *tree=0);
   virtual ~eleFastSmearerValidDataMc();
...
#ifdef eleFastSmearerValidDataMc_cxx
eleFastSmearerValidDataMc::eleFastSmearerValidDataMc(TTree *tree) : fChain(0) 
{
...
eleFastSmearerValidDataMc::~eleFastSmearerValidDataMc()
{
  if (!fChain) return;
  delete fChain->GetCurrentFile();
}

Int_t eleFastSmearerValidDataMc::GetEntry(Long64_t entry)
{
  // Read contents of entry.
  if (!fChain) return 0;
  return fChain->GetEntry(entry);
}
Long64_t eleFastSmearerValidDataMc::LoadTree(Long64_t entry)
{
...
void eleFastSmearerValidDataMc::Init(TTree *tree)
{
...
Bool_t eleFastSmearerValidDataMc::Notify()
{
...
void eleFastSmearerValidDataMc::Show(Long64_t entry)
{
...
Int_t eleFastSmearerValidDataMc::Cut(Long64_t entry)
{
...
#endif // #ifdef eleFastSmearerValidDataMc_cxx
