...
// Fri Jun 23 14:26:11 2017 by ROOT version 5.32/00
...
#ifndef eleFastSmearerValid_h
#define eleFastSmearerValid_h
...
public :
   ...
   eleFastSmearerValid(TTree *tree=0);
   virtual ~eleFastSmearerValid();
...
#ifdef eleFastSmearerValid_cxx
eleFastSmearerValid::eleFastSmearerValid(TTree *tree) : fChain(0) 
{
...
eleFastSmearerValid::~eleFastSmearerValid()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t eleFastSmearerValid::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t eleFastSmearerValid::LoadTree(Long64_t entry)
{
...
void eleFastSmearerValid::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("pdfWeight_cteq6ll", &pdfWeight_cteq6ll, &b_pdfWeight_cteq6ll);
...
Bool_t eleFastSmearerValid::Notify()
{
...
void eleFastSmearerValid::Show(Long64_t entry)
{
...
Int_t eleFastSmearerValid::Cut(Long64_t entry)
{
...
#endif // #ifdef eleFastSmearerValid_cxx
