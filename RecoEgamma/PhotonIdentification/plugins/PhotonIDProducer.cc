...
void PhotonIDProducer::produce(edm::Event& e, const edm::EventSetup& c) {
  ...
  std::unique_ptr<edm::ValueMap<Bool_t> > outlooseEM(new edm::ValueMap<Bool_t>());
  ...
  std::unique_ptr<edm::ValueMap<Bool_t> > outloose(new edm::ValueMap<Bool_t>());
  ...
  std::unique_ptr<edm::ValueMap<Bool_t> > outtight(new edm::ValueMap<Bool_t>());
