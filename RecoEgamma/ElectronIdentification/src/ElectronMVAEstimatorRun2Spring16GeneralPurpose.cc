...
int ElectronMVAEstimatorRun2Spring16GeneralPurpose::findCategory( const reco::GsfElectron * eleRecoPtr ) const {
...
bool ElectronMVAEstimatorRun2Spring16GeneralPurpose::
